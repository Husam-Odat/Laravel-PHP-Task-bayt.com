    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form action="{{ route('user.marks.update', $marks->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-xl-6">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-5">
                                    <label class="text-dark font-weight-medium">Exam</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text mdi mdi-account-card-details"
                                                id="basic-addon1"></span>
                                        ...
                                        <select class="form-control" name="exam_id" id="">
                                            <option value="">Choose a exams</option>
                                            @foreach ($exams as $exam)
                                                <option {{ $marks->exam_id == $exam->id ? 'selected' : '' }}
                                                    value="{{ $exam->id }}">{{ $exam->exam_title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
