...
use App\DataTables\HR_System\Subadmin\VacationsDataTable;
...
class VacationsController extends Controller
{
    ...
    {
        return $dataTable->render('subadmin.pages.sm-system.vacations.index');
    }
    ...
    public function create()
    {
        ...
        return view('subadmin.pages.sm-system.vacations.create', compact('students'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('subadmin.vacations.index')->with($notification);
    }
    ...
    public function edit($id)
    {
        ...
        return view('subadmin.pages.sm-system.vacations.edit', compact('vacation', 'students'));
    }
